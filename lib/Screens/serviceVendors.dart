...
class Vendors extends StatefulWidget {
  String id,city_id,vendor_type;
  Vendors({Key? key, required this.id,required this.city_id,required this.vendor_type}) : super(key: key);

  @override
  State<Vendors> createState() => _VendorsState(id,city_id,vendor_type);
}

class _VendorsState extends State<Vendors> {
  String id,city_id,vendor_type;
  _VendorsState(this.id,this.city_id,this.vendor_type);
  List vendorsList = [];
